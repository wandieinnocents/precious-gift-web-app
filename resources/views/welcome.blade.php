...
<!-- Responsive File -->
<link href="{{ asset('assets/frontend_assets/c  ss/responsive.css') }}" rel="stylesheet">

<link rel="{{ asset('assets/frontend_assets/shortcut icon" href="assets/frontend_assets//favicon.png') }}" type="image/x-icon">
...
<div class="page-wrapper">
    ...
    <header class="main-header header-style-two">
        ...
        <div class="header-upper">
            <div class="auto-container">
                <div class="inner-container clearfix">
                    <!--Logo-->
                    <div class="logo-box">
                        <div class="logo"><a href="index.html" title="Precious Gift"><img src="assets/frontend_assets/images/logo-2.png" alt="Kausid - Charity and Fundraising HTML Template" title="Kausid - Charity and Fundraising HTML Template"></a></div>
                    </div>
        ...
        <div class="sticky-header">
            <div class="auto-container clearfix">
                ...
                <div class="logo pull-left">
                    <a href="index.html" title=""><img src="assets/frontend_assets/images/sticky-logo.png" alt="" title=""></a>
                </div>
                <!--Right Col-->
        ...
        <div class="mobile-menu">
            ...
            <nav class="menu-box">
                <div class="nav-logo"><a href="index.html"><img src="assets/frontend_assets/images/nav-logo.png" alt="" title=""></a></div>
    ...
    <section class="banner-section style-two">
		<div class="banner-carousel kausid-carousel owl-theme owl-carousel" data-options='{"loop": true, "margin": 0, "autoheight":true, "lazyload":true, "nav": true, "dots": true, "autoplay": true, "autoplayTimeout": 6000, "smartSpeed": 300, "responsive":{ "0" :{ "items": "1" }, "768" :{ "items" : "1" } , "1000":{ "items" : "1" }}}'>
			...
			<!-- Slide Item -->
            <div class="slide-item">
                <div class="image-layer" style="background-image:url('assets/frontend_assets/images/main-slider/5.jpg')"></div>
            ...
            <!-- Slide Item -->
            <div class="slide-item">
                <div class="image-layer" style="background-image:url('assets/frontend_assets/images/main-slider/6.jpg')"></div>
                        ...
                        <div class="moto-block col-lg-4 col-md-6 col-sm-12">
                            <div class="inner-box">
                                <div class="inner">
                                    ...
                                    <div class="text">Auis nostrud exercitation ullam labor aliquip exsed consequat duis
                                        autpsum dolore magna aliqua minim</div>
                                </div>
                            </div>
                        </div>
                        <!--Moto Block-->
                    ...
                    <div class="kausid-carousel owl-theme owl-carousel"
                            ...
                            <div class="event-block-two">
                                <div class="inner-box">
                                    <figure class="image-box"><a href="event-single.html"><img
                                                src="images/resource/event-image-1.jpg" alt=""></a></figure>
                                    <div class="lower-box">
                        ...
                        <div class="slide-item">
                            ...
                            <div class="event-block-two blue-theme">
                                <div class="inner-box">
                                    <figure class="image-box"><a href="event-single.html"><img
                                                src="images/resource/event-image-2.jpg" alt=""></a></figure>
                                    <div class="lower-box">
