...
<body>
    <div class="page-wrapper">
                    ...
                    <div class="inner-container clearfix">
                        ...
                        <div class="logo-box">
                            <div class="logo"><a href="index.html" title="Precious Gift"><img
                                        src="assets/frontend_assets/images/logo-2.png"
                                        alt="Precious Gift"
                        ...
                        <div class="moto-block col-lg-4 col-md-6 col-sm-12">
                            <div class="inner-box">
                                <div class="inner">
                                    ...
                                    <div class="text">Auis nostrud exercitation ullam labor aliquip exsed consequat
                                        duis
        ...
        <section class="fun-facts-two">
            <div class="image-layer"
                style="background-image:url('assets/frontend_assets/images/background/parallax-bg-2.jpg')"></div>
